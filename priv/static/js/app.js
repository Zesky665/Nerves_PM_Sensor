...
var interval = setInterval(updatePM, 2000);

function update_value(new_val) {
  pm10.innerHTML = new_val.pm10;
  pm25.innerHTML = new_val.pm25;
}

function updatePM() {
  channel.push("update_pls", {}).receive("ok", function (resp) {
    console.log("Updated successfully", update_value(resp));
  });
}

// Now that you are connected, you can join channels with a topic:
var channel = socket.channel("sensor:pm", {});
